	...
	<div class="w3-container">
		...
		<div class="w3-col s9 " style="background: #EEE9E9"><p></p>
			<p style="padding-left:15px;">
				...
				<a href="index-search-much.php?search=<?php echo $search;?>"><button class="button55 button11">ราคามากไปน้อย</button></a>&nbsp;
		...
		<div class="cor"style="background: #F8F8F8" >
			<!-- container -->
				...
				<div class="row  " style=" margin-bottom: 30px;" >
					...
					<?php
						$sql = "SELECT * FROM `product` WHERE name_product LIKE '%$search%' ORDER BY price_product DESC ";
						$result = $con->query($sql);
