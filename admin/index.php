  ...
  <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic6">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="#">ประวัติการโอนเงเงิน(คืนสินค้า)</a></li>
              ...
              <div class="card">
                <div class="card-body dashboard-tabs p-0">
                  <ul class="nav nav-tabs px-4" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active" id="overview-tab" data-toggle="tab" href="#overview" role="tab" aria-controls="overview" aria-selected="true">ภาพรวม</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="sales-tab" data-toggle="tab" href="#sales" role="tab" aria-controls="sales" aria-selected="false">ขาย</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="purchases-tab" data-toggle="tab" href="#purchases" role="tab" aria-controls="purchases" aria-selected="false">การสั่งซื้อสินค้า</a>
                    </li>
                  </ul>
                    ...
                    <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                      <div class="d-flex flex-wrap justify-content-xl-between">
                        ...
                        <div class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
                          ...
                          <div class="d-flex flex-column justify-content-around">
                            <small class="mb-1 text-muted">รายได้</small>
                        ...
                        <div class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
                          ...
                          <div class="d-flex flex-column justify-content-around">
                            <small class="mb-1 text-muted">ยอดการสั่งซื้อ</small>
                        
                            <h5 class="mr-2 mb-0">222222</h5>
                        ...
                        <div class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
                          ...
                          <div class="d-flex flex-column justify-content-around">
                            <small class="mb-1 text-muted">สิงค้าทั้งหมด</small>
