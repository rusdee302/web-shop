...
<!--    <div class="container" style="padding: 10px"> 
	...
	<div class="container w3-panel w3-red">
 ...
 -->                     <br>
					...
					<div class="col-md-5">
						<div class="product-body">
							...
							<font color="#FF6347"> 
							<h2 class="product-price">฿<?php echo $price_product; ?>.00</font></h2> 
...
<!-- 							<?php
					...
					?> --><br><br>
                       ...
                       <div class="pull-left"> 
                         <div id="myDIV" >
					  <button class="btn w3-border" name="gender" style="width:35px;height:35px; font-size: 16px;background: red;"></button>
					  <button class="btn w3-border" name="gender" style="width:35px;height:35px; font-size: 16px;background: white"></button>
					  <button class="btn w3-border" name="gender" style="width:35px;height:35px; font-size: 16px;background: yellow"></button>
					  <button class="btn w3-border" name="gender" style="width:35px;height:35px; font-size: 16px;background: black;"></button>
					  <button class="btn w3-border" name="gender" style="width:35px;height:35px; font-size: 16px;background: blue;"></button>
                      
					  <p><br><b>ไซต์</b></p>
					  <button class="btn w3-border" name="gender" style="width:50px;height:35px; font-size: 14px;">S</button>
					  <button class="btn w3-border" name="gender" style="width:50px;height:35px; font-size: 14px;">M</button>
					  <button class="btn w3-border" name="gender" style="width:50px;height:35px; font-size: 14px;">L</button>
					  <button class="btn w3-border" name="gender" style="width:50px;height:35px; font-size: 14px;">XL</button>
					</div>
				    </div>
			        </div>
			...
			<div class="container w3-round-large"style="background: white"> 
				...
				<div class="row  " style=" margin-bottom: 30px;" >
					<div class="flex-into" >
						<?php
							// $id_member = $_GET['id_member'];
							$sql2 = "SELECT * FROM `product` WHERE `id_mamber` = $id_member AND `saled` >= 5 ORDER BY saled DESC";
							$result2 = $con -> query($sql2);

							if ($result2->num_rows > 0) {
								while ($row2 = $result2 -> fetch_assoc()) {
									$id_product = $row2['id_product'];
									$name_product = $row2['name_product'];
									$price_product = $row2['price_product'];
									$stock = $row2['stock'];
									$saled = $row2['saled'];
									$img_product = $row2['img_product'];
									$detail_product = $row2['detail_product'];
						...
						<div class="box-flex">
								...
								<div class="text-center">
									<strong class="tex-pr"><?php echo $price_product; ?></strong><span class="tex-p">บาท</span>
								</div>
								<!-- /div -->
						</div>
						</a>
