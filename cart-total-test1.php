 ...
 <div class="container">
        ...
        <div class="panel">
          <div class="panel-body">
            <a href="#"><input class="check-box" type="checkbox" aria-label="...">                 <tr>
                                  <th>สินค้า</th>
                                  <th></th>
                                  <th><?php include('tab/tab1.php'); ?>ราคาต่อชิ้น</th>
                                  <th><?php include('tab/tab2.php'); ?>จำนวน</th>
                                  <th><?php include('tab/tab3.php'); ?>ราคารวม</th>
       ...
       <?php } ?>
        ...
        <div class="panel">
          <div class="panel-body">
            <a href="#"> สรุปรายการสั่งซื้อ <hr>                <tr>
                                  <th></th>
                                  <th></th>
                                  <th><?php include('tab/tab1.php'); ?>
                                  
                                  </th>
                                  <th><?php include('tab/tab2.php'); ?>
                                    

                                  </th>
                                  <th><?php include('tab/tab3.php'); ?></th>
                                 
                                  
                                  <th><?php include('tab/tab3.php'); ?> จำนวนสินค้า  <?php
                                        $id_order=$_SESSION['id_order'];
                  ...
                  <tr>
                                  ...
                                  <th><?php include('tab/tab2.php'); ?></th>
                                  <th><?php include('tab/tab3.php'); ?></th>
                                 
                                  
                                  <th><?php include('tab/tab3.php'); ?>
                ...
                <tr>
                                  ...
                                  <th><?php include('tab/tab3.php'); ?>
                                    <a href="choice_save_bill.php"><button class="btn btn-success">ชำระเงิน</button> </a>
                                  </th>
                                  <th></th>
                </tr>
...
<!-- <div class="row">
  ...
  <!--   <div class="panel-body">
      ...
      ค่าจัดส่ง 50 บาท<br><br>
         ...
         <a href="choice_save_bill.php" class="btn btn-success btn-lg btn-block" role="button">ชำระเงิน</a>
        </div>
  </div> -->
  <div class="col-sm-1"></div>
